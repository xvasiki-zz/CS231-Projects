...
//check grid side cells and corner cells; add their neighbords to list
	...
	public void advance(){//creates new grid, creates new cells in grid, copies alive status from old to new grid, becomes nold 
	...
	public static void main(String[] args){
		Landscape landy = new Landscape(Integer.parseInt(args[0]),Integer.parseInt(args[1]));
		// landy.reset();
		...
		// landy.getNeighbors(); 
		System.out.println(landy.getNeighbors(1,2)); 
